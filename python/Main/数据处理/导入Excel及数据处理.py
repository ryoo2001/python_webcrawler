...
new_excel = excel_book.add_sheet("sheet1", cell_overwrite_ok=True) # cell_overwrite_ok单元格内容覆写开关
...
# 保存数据
savepatch = "python/crawler/test.xls"
excel_book.save(savepatch) #保存文件到savepatch目录下,文件名为:test